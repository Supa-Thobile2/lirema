  ...
  return (
    <div>
        ...
        <div className='border-6 p-12 space-y-14 mt-12 space-y-4 md:p-18 md:space-y-24 lg:p-14  lg:space-y-16 xl:p-14  flex items-center justify-center flex-col'>
            <p className='p-4 border text-sm font-bold'>ICT Solutions</p>
            <h1 className='text-3xl md:text-8xl lg:text-4xl font-bold font-700'>ICT solutions</h1>
        ...
        <div className='border-6  p-12 space-y-14  md:p-18 md:space-y-24 lg:p-14  lg:space-y-16 xl:p-14  flex items-center justify-center flex-col'>
            <p>ICT solutions</p>
            <h1 className='text-lg font-bold font-700'>ICT Expertise</h1>
        ...
        <div className='border-6 p-8  space-y-2  flex items-center justify-center flex-col'>
            <p>ICT solutions</p>'
            <h1 className='text-lg font-bold font-700'>ICT Solutions</h1>
            <div className='block space-y-2 md:flex items-center justify-between'>
                <div className='space-y-2 border p-6'>
                    <h4 className='text-lg font-700 font-bold'>Lorem ipsum dolor sit.</h4>
                    <p>Lorem ipsum dolor sit.</p>
                    <div className='flex gap-4'>
                        <div className='flex gap-4'>
                            <div className='w-full'>
                                <button className='w-full p-2 border'>Learn More</button>
                            </div>
                            <div className='w-full'>
                                <button className='w-full p-2 border'>Learn More</button>
                            </div>
