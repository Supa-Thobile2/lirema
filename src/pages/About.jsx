...
function About() {
  return (
    ...
    <div className='block w-full  p-6 md:flex items-center justify-center'>
    <div className='border w-full p-4  space-y-2 md:w-3/4  flex flex-col space-y-2 md:space-y-8  md:p-16  mx-auto'>
        <h6 className='text-md font-semibold text-left'>About </h6>
        <h1 className='text-lg font-bold'>Transforming engineering challenges into innovative solutions </h1>
