...
function Hero() {
  ...
  return (
    ...
    <div className='w-full mx-auto  md:w-1/2  p-8 md:p-18 xl:p-20 md:space-y-16 lg:p-16 lg:space-y-18 text-center  flex items-center justify-center flex-col  mx-auto'>
