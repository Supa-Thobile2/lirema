...
function Subscribe() {
  return (
    <div className='space-y-8 flex items-center justify-center flex-col p-8 space-y-8'>

    <h1 className='text-xl font-bold font-200'>Stay Informed Engineering insights</h1>
