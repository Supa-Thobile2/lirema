...
function Choose() {
  return (
    <div className='block md:flex items-center justify-center flex-col p-6 space-y-4 md:p-20 space-y-2'>
        ...
        <div className='block space-y-2 md:flex gap-4 p-2'>
            <div className='flex items-center justify-between flex-col space-y-4'>
                ...
                <div className='border space-y-4 p-4 md:p-8'>
                    <h1 className='text-lg font-bold'>Technical expertise</h1>
                    <p className='text-sm font-medium'>Highly skilled engineers with deep technical knowledge</p>
                    <div>
                        <button className=''>Explore capabilities</button>
            ...
            <div className='w-full block md:flex border  space-y-8'>
                <div className='space-y-4 flex items-center justify-center p-4 md:p-8 flex-col w-full space-y-2 md:w-1/2'>
