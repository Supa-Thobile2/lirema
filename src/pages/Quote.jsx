...
function Quote() {
  return (
    <div className='block p-8 space-y-8 md:flex items-center justify-center md:p-16'>
        <div className='space-y-8'>
            ...
            <div className='flex items-center gap-6 w-full'>
                <button className='p-2 border w-full'>Quote</button>
                <button className='p-2 border w-full'>Consult</button>
            </div>
        </div>
        <div>
            <img src={img} alt=''/>
